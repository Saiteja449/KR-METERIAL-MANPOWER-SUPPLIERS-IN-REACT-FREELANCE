...
export const AdminLayout = () => {
  ...
  const navItems = [
    ...
    },
    {
      ...
      icon: <Gift size={18} className="text-amber" />,
    },
  ];
    ...
    <div className="min-h-screen bg-slate-100 flex flex-col md:flex-row">
      ...
      <header className="md:hidden bg-navy-dark text-white p-4 flex items-center justify-between border-b border-navy-light sticky top-0 z-40">
        ...
        <button
          ...
          className="text-gray-300 hover:text-amber p-1.5 transition-colors cursor-pointer"
        >
        ...
        <div className="p-4 border-t border-navy-light bg-navy/60">
          ...
          <div className="grid grid-cols-2 gap-2 pt-2">
            ...
            <button
              ...
              className="flex items-center justify-center gap-1.5 py-2 px-2 rounded-sm bg-rose-950/40 hover:bg-rose-900/60 text-rose-300 text-[11px] font-semibold transition-colors cursor-pointer"
            >
              <LogOut size={12} />
              <span>Logout</span>
            </button>
