    ...
    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 py-4 px-2 text-sm text-gray-600">
      ...
      <div className="flex items-center gap-1">
        <button
          ...
          className="p-2 rounded-sm border border-gray-300 hover:bg-gray-50 disabled:opacity-40 disabled:cursor-not-allowed text-navy transition-colors cursor-pointer"
          title="Previous Page"
        >
          <ChevronLeft size={16} />
        </button>
        ...
        {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
          ...
          return (
            <button
              ...
              className={`w-8 h-8 rounded-sm text-xs font-semibold transition-colors cursor-pointer ${
                currentPage === pageNum
